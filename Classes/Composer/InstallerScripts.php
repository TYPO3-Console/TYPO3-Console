...
class InstallerScripts
{
    ...
    {
        if (!$calledFromPlugin) {
            $event->getIO()->write('<comment>Usage of Helhum\Typo3Console\Composer\InstallerScripts::setup is deprecated. Please remove this section from your root composer.json</comment>');
            return;
        }
