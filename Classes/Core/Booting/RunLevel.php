...
class RunLevel
{
    ...
    {
        $executionOrder = [self::LEVEL_ESSENTIAL, self::LEVEL_MINIMAL, self::LEVEL_FULL];
    ...
    protected function buildCompiletimeSequence()
    {
        ...
        $sequence->addStep(new Step('helhum.typo3console:providecleanclassimplementations', ['Helhum\Typo3Console\Core\Booting\Scripts', 'provideCleanClassImplementations']));
    ...
    protected function buildBasicRuntimeSequence($identifier = self::LEVEL_MINIMAL, $parentSequence = null)
    {
        ...
        if (empty($this->executedSequences[self::LEVEL_COMPILE])) {
            ...
            $sequence->addStep(new Step('helhum.typo3console:providecleanclassimplementations', ['Helhum\Typo3Console\Core\Booting\Scripts', 'provideCleanClassImplementations']), 'helhum.typo3console:extensionconfiguration');
        }
    ...
    protected function addStep($sequence, $stepIdentifier, $isDummyStep = false)
    {
        switch ($stepIdentifier) {
            ...
            case 'helhum.typo3console:disablecorecaches':
                $sequence->addStep(new Step('helhum.typo3console:disablecorecaches', ['Helhum\Typo3Console\Core\Booting\Scripts', 'disableCoreCaches']), 'helhum.typo3console:coreconfiguration');
                break;

            // Part of basic runtime
            case 'helhum.typo3console:extensionconfiguration':
                $action = $isDummyStep ? function () {
                } : ['Helhum\Typo3Console\Core\Booting\Scripts', 'initializeExtensionConfiguration'];
            ...
            case 'helhum.typo3console:enablecorecaches':
                $action = $isDummyStep ? function () {
                } : ['Helhum\Typo3Console\Core\Booting\Scripts', 'reEnableOriginalCoreCaches'];
            ...
            case 'helhum.typo3console:database':
                $action = $isDummyStep ? function () {
                } : ['Helhum\Typo3Console\Core\Booting\Scripts', 'initializeDatabaseConnection'];
            ...
            case 'helhum.typo3console:persistence':
                $action = $isDummyStep ? function () {
                } : ['Helhum\Typo3Console\Core\Booting\Scripts', 'initializePersistence'];
            ...
            case 'helhum.typo3console:authentication':
                $action = $isDummyStep ? function () {
                } : ['Helhum\Typo3Console\Core\Booting\Scripts', 'initializeAuthenticatedOperations'];
            ...
            case 'helhum.typo3console:runLegacyBootstrap':
                $sequence->addStep(new Step('helhum.typo3console:runLegacyBootstrap', ['Helhum\Typo3Console\Core\Booting\Scripts', 'runLegacyBootstrap']));
                break;
    ...
    public function isCommandAvailable($commandIdentifier)
    {
        ...
        if ($availableRunlevel === self::LEVEL_COMPILE) {
            if (in_array($expectedRunLevel, [self::LEVEL_FULL, self::LEVEL_MINIMAL, self::LEVEL_LEGACY])) {
                $isAvailable = false;
            }
        }
